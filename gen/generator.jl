...
const deps_jlls = [aws_c_auth_jll, aws_c_cal_jll, aws_c_common_jll, aws_c_compression_jll, aws_c_http_jll, aws_c_io_jll, aws_c_sdkutils_jll, aws_checksums_jll]
const deps = [LibAwsAuth, LibAwsCal, LibAwsCommon, LibAwsCompression, LibAwsHTTP, LibAwsIO, LibAwsSdkutils, LibAwsChecksums]
...
for target in JLLEnvs.JLL_ENV_TRIPLES
    ...
    header_dirs = []
    inc = JLLEnvs.get_pkg_include_dir(aws_c_s3_jll, target)
    push!(args, "-I$inc")
